...
describe('TechListService', () => {
  ...
  describe('#getAllCndidates', () => {
    let expectedCandidates: Candidate[];
    ...
    it('should return expected candidates by calling once', () => {
      techService
        .getCandidates()
        .subscribe(
          ($candidates: Candidate[]) =>
            expect($candidates).toEqual(
              expectedCandidates,
              'should return expected candidates'
            ),
          fail
        );
      const req = httpTestingController.expectOne(techService.getUrl);
